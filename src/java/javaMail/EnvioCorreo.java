...
public class EnvioCorreo {
    ...
    public static void enviarCorreo(String servidor, String puerto, final String usuario, final String clave, String direccion, String asunto, String mensaje) throws AddressException, MessagingException {
